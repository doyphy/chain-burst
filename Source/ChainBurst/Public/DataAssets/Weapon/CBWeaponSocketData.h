...
public:
	/**
	 * WeaponCombatType 에 맞는 소켓 설정을 반환
	 * @param InType    조회할 무기 종류
	 * @param OutConfig 반환될 소켓 설정
	 * @return 찾으면 true, 못 찾으면 false
	 */
	bool FindSocketConfig(ECBWeaponCombatType InType, FCBWeaponSocketConfig& OutConfig) const;

private:
	/** 무기 종류별 소켓 설정 배열 */
	UPROPERTY(EditDefaultsOnly, Category = "Socket",
		meta = (TitleProperty = "WeaponCombatType"))
