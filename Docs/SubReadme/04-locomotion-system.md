...
- 판별 우선순위(Sprint > Walk > Run)는 공용 헬퍼 하나로 통일했음. 
  - 애님 인스턴스 · 회전 컴포넌트 · 입력 매니저 · 몽타주 인덱스 계산이 전부 같은 함수를 씀.
...
> 🔎 관련 문서 [Notion - 피벗 기능](https://sprout-whitefish-298.notion.site/v1-5_-3972a74e9c6f8025b665ff74a4e5b04f)
