...
void UCBExtensionComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UCBExtensionComponent::NativeOnCharacterSystemReady()
{
...
void UCBExtensionComponent::OnCharacterSystemReady()
{
	// 기본 구현은 비어 있음. 자식 컴포넌트가 필요 시 오버라이드.
}
